Shader "Custom/TestShader01"
{
    ...
    SubShader
    {
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            float4 _UV_56c5127afd5e44d4bf750629283aa380_Out_0 = IN.uv1;
            float _Split_610cd68f481c482b82f78a6b9cb03560_R_1 = _UV_56c5127afd5e44d4bf750629283aa380_Out_0[0];
            float _Split_610cd68f481c482b82f78a6b9cb03560_G_2 = _UV_56c5127afd5e44d4bf750629283aa380_Out_0[1];
            float _Split_610cd68f481c482b82f78a6b9cb03560_B_3 = _UV_56c5127afd5e44d4bf750629283aa380_Out_0[2];
            float _Split_610cd68f481c482b82f78a6b9cb03560_A_4 = _UV_56c5127afd5e44d4bf750629283aa380_Out_0[3];
            float _Lerp_7e25fd9f1a974a269648a166cbd0f9ea_Out_3;
            Unity_Lerp_float(_Split_610cd68f481c482b82f78a6b9cb03560_G_2, 1, -1.3, _Lerp_7e25fd9f1a974a269648a166cbd0f9ea_Out_3);
            surface.BaseColor = IsGammaSpace() ? float3(0.5, 0.5, 0.5) : SRGBToLinear(float3(0.5, 0.5, 0.5));
            surface.NormalTS = IN.TangentSpaceNormal;
            surface.Emission = float3(1, 0.8827147, 0.8066038);
            surface.Metallic = 0;
            surface.Smoothness = 0.5;
            surface.Occlusion = 1;
            surface.Alpha = _Lerp_7e25fd9f1a974a269648a166cbd0f9ea_Out_3;
            return surface;
        }
        ...
        PackedVaryings PackVaryings (Varyings input)
        {
            ...
            ZERO_INITIALIZE(PackedVaryings, output);
            output.positionCS = input.positionCS;
            output.interp0.xyzw =  input.texCoord1;
            #if UNITY_ANY_INSTANCING_ENABLED
            output.instanceID = input.instanceID;
            #endif
            #if (defined(UNITY_STEREO_MULTIVIEW_ENABLED)) || (defined(UNITY_STEREO_INSTANCING_ENABLED) && (defined(SHADER_API_GLES3) || defined(SHADER_API_GLCORE)))
        ...
        Varyings UnpackVaryings (PackedVaryings input)
        {
            Varyings output;
            output.positionCS = input.positionCS;
            output.texCoord1 = input.interp0.xyzw;
            #if UNITY_ANY_INSTANCING_ENABLED
            output.instanceID = input.instanceID;
            #endif
            #if (defined(UNITY_STEREO_MULTIVIEW_ENABLED)) || (defined(UNITY_STEREO_INSTANCING_ENABLED) && (defined(SHADER_API_GLES3) || defined(SHADER_API_GLCORE)))
